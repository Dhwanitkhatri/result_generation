...
// to fetch the there own student details 
...
// ==================== GET SINGLE STUDENT (AUTHENTICATED) ====================
...
// ==================== DELETE STUDENT + LINKED USER (ADMIN) ====================
router.delete("/:id", authenticate, authorize("admin"), async (req, res) => {
    ...
    try {
        ...
        res.json({ message: "Student, linked user, and related results deleted successfully" });
